...
//	    String sportID = Contracts.SPORT_ID_ROAD;
...
//	    Boolean result = competitionService.loadCompetitionsService(sportID, genderID, classID, initDate, finishDate);
